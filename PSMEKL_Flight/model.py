...
class Model():
    ...
    def fit(self, dataset, emb_feats, adj):
        ...
        train_labels = dataset.y.to(self.args.device)
        ...
        for epoch in range(1, 1 + self.args.epochs):
            ...
            # In this way, puting all nodes affects the computing of mean and variance of BN layer,
            # Then using net.eval() will provide bad results, so we return train val test result in transductive way.
            # This phenomenon appears in some special datasets such as airplane-related but not all datasets
            # Moreover, this phenomenon appears when we use pagerank algorithm
